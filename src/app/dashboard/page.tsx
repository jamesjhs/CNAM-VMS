    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          <DashCard title="Schedule" icon="📅" href="/schedule" description="Browse events, sign up for shifts, and record your availability." />
          <DashCard title="Announcements" icon="📣" href="/announcements" description="Latest news and updates from the museum." />
          <DashCard title="My Availability" icon="🗓️" href="/volunteer/availability" description="Set the activities you are generally available to help with." />
